...
public class AddCustomerPage extends BasePage {
	...
	WebElement COUNTRY_DROP_DOWN_ELEMENT;
	...
	WebElement ADD_CUSTOMER_IN_LIST_CUSTOMER_ELEMENT;
	@FindBy(how = How.XPATH, using = "//*[@id=\"foo_filter\"]")
	WebElement SEARCH_BAR_IN_LIST_CUSTOMER_ELEMENT;
	// @FindBy(how = How.XPATH, using = "//*[@id=\"foo_filter\"]") WebElement
	// SEARCH_BAR_IN_LIST_CUSTOMER_ELEMENT;
	...
	// Delete button:
	// tbody/tr[1]/td[7]/a[2]
	//tbody/tr[2]/td[7]/a[1] --> profile xpath
	...
	public void validateSearchBoxAndProfileButton() {
		...
		for(int i = 1; i <= 9; i++) {
			String name = driver.findElement(By.xpath(before_xpath + i + after_xpath)).getText();
			if(name.contains(enteredName)) {
				System.out.println("Entered namne exist");
